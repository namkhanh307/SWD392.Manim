...
public class Swd392Context : IdentityDbContext<ApplicationUser, ApplicationRole, Guid, ApplicationUserClaims, ApplicationUserRoles, ApplicationUserLogins, ApplicationRoleClaims, ApplicationUserTokens>
{
   ...
   // public virtual DbSet<SolutionType> SolutionTypes { get; set; }
    ...
    private string? GetConnectionString()
    {
        ...
        return "server=manimsql.database.windows.net;database=swd-manim;uid=adminmanim;pwd=Jpassword@;TrustServerCertificate=True";
        //return "server=DESKTOP-2I4K8I6\\SQLEXPRESS;database=swd-manim;uid=sa;pwd=12345;Trusted_Connection=True;Trust Server Certificate=True;Timeout=30;";
